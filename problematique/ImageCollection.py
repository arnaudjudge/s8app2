...
class ImageCollection:
    ...
    def view_histogrammes(indexes):
        ...
        for num_images in range(len(indexes)):
            ...
            ax[num_images, 1].scatter(range(start, end), pixel_valuesLab[0, start:end], c='pink')
            ax[num_images, 1].scatter(range(start, end), pixel_valuesLab[1, start:end], c='orange')
            ax[num_images, 1].scatter(range(start, end), pixel_valuesLab[2, start:end], c='cyan')
            ...
            # 3e histogramme
            ax[num_images, 2].scatter(range(start, end), pixel_valuesHSV[0, start:end], c='black')
            ax[num_images, 2].scatter(range(start, end), pixel_valuesHSV[1, start:end], c='purple')
            ax[num_images, 2].scatter(range(start, end), pixel_valuesHSV[2, start:end], c='yellow')
